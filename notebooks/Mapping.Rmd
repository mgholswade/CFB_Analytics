...
blue_conf_games = conf_games[which(conf_games['col_conf'] == 'Blue'),]
other_conf_games = conf_games[which(conf_games['col_conf'] == 'Other'),]
red_conf_games = conf_games[which(conf_games['col_conf'] == 'Red'),]
...
rownames(blue_conf_games) <- 1:nrow(blue_conf_games)
